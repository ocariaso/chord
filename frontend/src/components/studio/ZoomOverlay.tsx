    ...
    >
      <div className="flex min-h-full items-center justify-center">
        <div ref={cardRef} onClick={(e) => e.stopPropagation()} className="relative">
          <button
            onClick={handleClose}
            className="absolute -right-2 -top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full bg-neutral-800 text-neutral-300 shadow-lg hover:bg-neutral-700"
          >
