...
export function OtherAmp({
  ...
  useStemWaveform(containerRef, name, buffer, downloadHref, "#4a4a4e", "#d4d4d8", 20, onWaveSurferReady);
  ...
  return (
    <div
      ...
      style={{ width: AMP_WIDTH, background: "linear-gradient(180deg,#5a5a5e 0%, #45454a 50%, #3a3a3e 100%)", borderColor: "#2a2a2e" }}
    >
