...
/** `.ch-wave`, clipped to the stem's real envelope in place of the stylesheet's placeholder shapes (design.md#classes), under the playhead. A pointer shortcut to seek, same as the chord strip. */
export function StemWaveform({ envelope, off, progress, duration, onSeek }: StemWaveformProps) {
  ...
  return (
    ...
    <span
      className="relative order-5 flex min-w-0 flex-[1_1_100%]"
